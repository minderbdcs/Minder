...
class AwaitingChecking_PartialDespatch_NotAllowedTest extends MinderAcceptanceTestCase {
    const ORDER = 'S99999998L999';
    const LABEL_NO = 'D899998';

    /**
     * @param $licensee
     * @dataProvider dataSource
     */
    function testIfPartialDespatchNotAllowedShouldNotExecuteConsequenceDespatch($licensee) {
    ...
    protected function orderSeed() {
        return $this->createYamlDataset(dirname(__FILE__). '/not_allowed_seed.yml');
    }
}