...
class AwaitingChecking_EdiOrders_PartialOrderPolicyTest extends MinderAcceptanceTestCase {
...
//        $this->cleanInsert()->execute($this->getConnection(), $this->deviceSeed());
    ...
    protected function _orderDataSeed() {
        return $this->createYamlDataset(dirname(__FILE__). '/partial_order_policy_seed.yml');
