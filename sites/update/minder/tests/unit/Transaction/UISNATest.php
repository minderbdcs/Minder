...
// Call Transaction_UISNATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UISNATest::main');
}
...
/**
 * Include the definition of the Transaction_UISNA class
 */
require_once 'Transaction/UISNA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UISNATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UISNATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UISNATest');
