...
// Call Transaction_UIKTATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UIKTATest::main');
}
...
/**
 * Include the definition of the Transaction_UIKTA class
 */
require_once 'Transaction/UIKTA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UIKTATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UIKTATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UIKTATest');
