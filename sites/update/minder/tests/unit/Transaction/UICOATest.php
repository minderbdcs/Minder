...
// Call Transaction_UICOATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UICOATest::main');
}
...
/**
 * Include the definition of the Transaction_UICOA class
 */
require_once 'Transaction/UICOA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UICOATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UICOATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UICOATest');
