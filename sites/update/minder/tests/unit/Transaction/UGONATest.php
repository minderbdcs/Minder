...
// Call Transaction_UGONATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UGONATest::main');
}
...
/**
 * Include the definition of the Transaction_UGONA class
 */
require_once 'Transaction/UGONA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UGONATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UGONATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UGONATest');
