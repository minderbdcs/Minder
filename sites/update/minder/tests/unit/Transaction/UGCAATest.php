...
// Call Transaction_UGCAATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UGCAATest::main');
}
...
/**
 * Include the definition of the Transaction_UGCAA class
 */
require_once 'Transaction/UGCAA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UGCAATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UGCAATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UGCAATest');
