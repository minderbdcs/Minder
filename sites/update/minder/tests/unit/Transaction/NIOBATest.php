...
// Call Transaction_NIOBATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_NIOBATest::main');
}
...
/**
 * Include the definition of the Transaction_NIOBA class
 */
require_once 'Transaction/NIOBA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_NIOBATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_NIOBATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_NIOBATest');
