...
// Call Transaction_GRNDLTest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_GRNDLTest::main');
}
...
/**
 * Include the definition of the Transaction_GRNDL class
 */
require_once 'Transaction/GRNDL.php';
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_GRNDLTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_GRNDLTest');
    ...
    */
    public function testgetObjectId()
    {
        ...
        $cls->containerNo   = '666666666666666666666666666666666666666677777777778888888888';
        $cls->containerType = '777777777777777777777777777777777777777788888888889999999999';
        $cls->printerId     = '88888888888888888888888888888888888888889999999999aaaaaaaaaa';
        $cls->grnLabelQty   = '9999999999999999999999999999999999999999aaaaaaaaaabbbbbbbbbb';
