...
// Call Transaction_UGHPATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UGHPATest::main');
}
...
/**
 * Include the definition of the Transaction_UGHPA class
 */
require_once 'Transaction/UGHPA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UGHPATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UGHPATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UGHPATest');
    ...
    */
    ...
    {
        $cls = new Transaction_UGHPA;
        $this->assertEquals("", $cls->getObjectId());
        $cls->grnId       = '111111111111111111111111111111111111111122222222223333333333';
        $cls->palletOwner = '222222222222222222222222222222222222222233333333334444444444';
        $cls->palletQty   = '333333333333333333333333333333333333333344444444445555555555';
    ...
    */
    public function testgetQuantity()
    {
        ...
        $cls->palletOwner = '222222222222222222222222222222222222222233333333334444444444';
        $cls->palletQty   = '333333333333333333333333333333333333333344444444445555555555';
        $this->assertEquals("333333333333333333333333333333333333333344444444445555555555", $cls->getQuantity());
    }
