...
// Call Transaction_UGSNATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UGSNATest::main');
}
...
/**
 * Include the definition of the Transaction_UGSNA class
 */
require_once 'Transaction/UGSNA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UGSNATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UGSNATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UGSNATest');
