...
// Call Transaction_UISCATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UISCATest::main');
}
...
/**
 * Include the definition of the Transaction_UISCA class
 */
require_once 'Transaction/UISCA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UISCATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UISCATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UISCATest');
