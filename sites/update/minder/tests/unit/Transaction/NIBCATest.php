...
// Call Transaction_NIBCATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_NIBCATest::main');
}
...
/**
 * Include the definition of the Transaction_NIBCA class
 */
require_once 'Transaction/NIBCA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_NIBCATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_NIBCATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_NIBCATest');
    ...
    */
    ...
    {
        $cls = new Transaction_NIBCA;
        $this->assertEquals("", $cls->getObjectId());
        $cls->ssnId       = '111111111111111111111111111111111111111122222222223333333333';
        $cls->brandCodeValue = '222222222222222222222222222222222222222233333333334444444444';
