...
// Call Transaction_NITPATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_NITPATest::main');
}
...
/**
 * Include the definition of the Transaction_NITPA class
 */
require_once 'Transaction/NITPA.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_NITPATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_NITPATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_NITPATest');
