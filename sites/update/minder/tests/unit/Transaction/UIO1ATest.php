...
// Call Transaction_UIO1ATest::main() if this source file is executed directly.
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Transaction_UIO1ATest::main');
}
...
/**
 * Include the definition of the Transaction_UIO1A class
 */
require_once 'Transaction/UIO1A.php';

/**
 * Automatic test based on PHPUnit for
 * Transaction_UIO1ATest
 ...
 * @link      http://www.barcoding.com.au/
 */
class Transaction_UIO1ATest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public static function main()
    {
        ...
        $suite  = new PHPUnit_Framework_TestSuite('Transaction_UIO1ATest');
