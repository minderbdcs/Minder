...
{
	selectBox[count].selected = true;

}
}
function checkSelect1()
{
var myselect = document.forms['getissn'].ssn_type;
...
{
var myselect = document.forms['getissn'].generic;
var myindex = myselect.selectedIndex;
if (myindex == 0)
{
	selectAll(myselect);
...
{
var myselect = document.forms['getissn'].brand;
var myindex = myselect.selectedIndex;
if (myindex == 0)
{
	selectAll(myselect);
...
{
var myselect = document.forms['getissn'].company;
var myindex = myselect.selectedIndex;
if (myindex == 0)
{
	selectAll(myselect);
...
{
var myselect = document.forms['getissn'].wh;
var myindex = myselect.selectedIndex;
if (myindex == 0)
{
	selectAll(myselect);
...
echo ("<TR>\n");
echo ("<TD>\n");
echo("<SELECT multiple name=\"ssn_type[]\" size=\"5\" onchange=\"checkSelect1()\" >\n");
