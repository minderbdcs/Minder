...
if ($original_type == 'I')
{
	echo("Despatch Transfer<BR>Into Location<BR><INPUT type=\"text\" name=\"location\" size=\"10\" >");
}
else
{
	echo("Despatch Transfer All<BR>Into Location<BR><INPUT type=\"text\" name=\"location\" size=\"10\" >");
}
