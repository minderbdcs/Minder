...
echo("<FORM action=\"getfromqty.php\" method=\"post\" onSubmit=\"processEdit3();return processEdit('$prod_no','F');\" name=getprod>");
echo("Part: <INPUT type=\"text\" name=\"scannedprod\" size=\"30\"");
