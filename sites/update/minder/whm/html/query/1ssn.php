...
{
	$Query = "";
	$log = fopen('/data/tmp/query1SSN.log' , 'a');
		$wk_current_time = "";
...
*/
$backto = 'getlocn.php';
/* if came from  ssn.php  then make go back to ssn.php
   if came from getlocn directly then go back there */
if ($ssn_id == $location)
{
