...
function processEdit() {
  ...
  if (mytype == "none")
  {
	...
	else
	{
		...
		document.getissn.qty.value = "";
		document.getissn.qty.value = defaultqty;
		document.getissn.audited.value="N";
		return false;
	}
  }
...
?>
 ...
 <form action="GetSTKISSN2.php" method="post" name=getissn ONSUBMIT="return processEdit2(0);">
<?php
...
if (isset($prodlocn))
{
	...
	/* save screen space */
	{
		...
		echo(" size=\"7\"");
		echo(" maxlength=\"10\" onchange=\"return processEdit()\" ");
