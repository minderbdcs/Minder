...

{
	...
	$retfrom = getBDCScookie($Link, $tran_device, "owner" );
...
if (isset($from))
{
	if ($from == "verifyLP.php")
	{
		//echo("<form action=\"transLPNV.php\" method=\"post\" name=getcomplete>\n");
		echo("<form action=\"transLPNV.php\" ");
	} else {
		if ($from == "verifyLPOtherQty.php")
		{
			echo("<form action=\"transLPNV.php\" ");
		} else {
			if ($from == "getverifyLP.php")
			{
				echo("<form action=\"transLPNV.php\" ");
			} else {
				//echo("<form action=\"transLPNVQ.php\" method=\"post\" name=getcomplete>\n");
				echo("<form action=\"transLPNVQ.php\" ");
			}
		}
	}
} else {
...
echo(" method=\"post\" name=getcomplete ONSUBMIT=\"return processEdit();\">\n");
if (isset($type))
{
...
//	delivery complete
	...
	//echo("<input type=\"submit\" name=\"completeyes\" value=\"Yes\">\n");  
	//echo("<input type=\"submit\" name=\"completeno\" value=\"No\">\n");  
