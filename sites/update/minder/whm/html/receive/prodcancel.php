...
//echo("<div id=\"col3\">");
echo("<div id=\"col16\">");
echo("<form action=\"" . $from . "\" method=\"post\" name=getsuppliers>");
if (isset($type))
{
...
//echo("<div id=\"col5\">");
echo("</div>\n");
echo("<div id=\"getcancel\">");
//	cancel delivery 
        echo("<fieldset>\n");
        echo("<legend>Cancel</legend>\n");
        echo("<h5>Cancel Delivery?</h5>\n");
	echo("<INPUT type=\"submit\" name=\"cancelyes\" value=\"Yes\">\n");  
	echo("<INPUT type=\"submit\" name=\"cancelno\" value=\"No\">\n");  
        echo("</fieldset>\n");
echo("</div>\n");
?>
</html>
