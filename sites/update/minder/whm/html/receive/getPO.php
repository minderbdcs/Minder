...
}
{
	...
	echo("<input type=\"text\" name=\"order\" maxlength=\"20\" size=\"20\" value=\"$order\" onchange=\"document.forms.getpo.submit();\" class=\"default\">\n");
...
if ($order <> "")
{
	if (strpos($order, "%") === false)
	{
		$wkQueryList .= "pl.purchase_order like '%" . strtoupper( $order ) . "%' and ";
	} else {
		$wkQueryList .= "pl.purchase_order like '" . strtoupper( $order ) . "' and ";
	}
}

$wkQueryList .= " pl.po_line_status in ('OP', 'CF') and po2.order_type = '$type' ";
$wkQueryList .= " and po2.po_status in ('OP', 'CF')  ";
$wkQueryList .= "group by po2.purchase_order, po2.po_date, po2.company_id, po2.person_id, pp.first_name ";
	//echo $wkQueryList;
...
$wkHeaders .= "<th></th>\n";
$wkHeaders .= "<th>PO</th>\n";
$wkHeaders .= "<th>Due Date</th>\n";
$wkHeaders .= "<th>Company</th>\n";
$wkHeaders .= "<th>Whom</th>\n";
$wkHeaders .= "</tr>";
