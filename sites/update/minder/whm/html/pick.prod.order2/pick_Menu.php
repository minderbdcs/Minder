...
echo('<h2 ALIGN="LEFT">Pick by Order2 Menu ');
...
echo('</h2>');
	...
	$pick_method .= "PRINTDESPATCH,"; /* continue buttons */
...
Next Order");
	...
	if ($wk_sysuser == 'T' or $wk_saleuser == 'T')
	{
		addMenuButton(",STATUS,", $pick_method, "ViewAllocate.php", "HowMany", "/icons/whm/button.php?text=Status&fromimage=Blank_Button_50x100.gif", "Status");
	}
	...
	// print/reprint despatch
	addMenuButton(",PRINTDESPATCH,", $pick_method , "GetDespatch.php", "despatchprint", "/icons/whm/button.php?text=Print+Despatch&fromimage=Blank_Button_50x100.gif", "Print 
Despatch");
