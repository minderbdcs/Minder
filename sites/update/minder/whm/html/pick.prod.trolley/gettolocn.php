...
echo ("<TABLE>\n");
echo ("<TR>\n");
echo("<TD colspan=\"2\" >Scan Despatch/Trolley Location</TD>\n");
echo ("</TR>\n");
//echo ("</TABLE>\n");
//release memory
ibase_free_result($Result);
...
*/
	{
		$alt = "View Empty Locations";
		echo ("<TR>");
		echo ("<TD>");
		echo("<FORM action=\"gettoempty.php\" method=\"post\" name=toempty>\n");
		//echo("<INPUT type=\"hidden\" name=\"ttype\" value=\"" . $original_type . "\" >");
		echo("<INPUT type=\"hidden\" name=\"ttype\" value=\"" . $type . "\" >");
		echo("<INPUT type=\"hidden\" name=\"order\" value=\"$order\" >");
...
*/
		echo('SRC="/icons/whm/viewemptytrolleylocations.gif" alt="' . $alt . '"></INPUT>');
		echo("</FORM>");
		echo ("</TD>");
		echo ("</TR>");
	}
