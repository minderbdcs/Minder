...
echo('<h4 ALIGN="LEFT">Pick by Trolley Menu ');
...
//ibase_close($Link);
	$pick_method = "";
	$pick_method .= ",VIEWOPEN,";
	$pick_method .= ",CONTINUE,";
	$pick_method .= ",MOVEDESPATCH,";
	...
	if ($despatch_tot <> 0)
	{
		...
		addMenuButton(",MOVEDESPATCH,", $pick_method , "gettoso.php", "despatch", "/icons/whm/pick.despatch.trolley.gif", "Move
Despatch");
	}
