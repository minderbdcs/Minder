...
if (isset($_COOKIE['LoginUser']))
{
	...
	$my_message = "";
	//echo("dotransaction_response($trans_type, $tran_tranclass, $my_object, $location, $my_sublocn, $my_ref, $tran_qty, $my_source, $tran_user, $tran_device)");
