<?php
	...
	{
		list( $wk_orig_issn, $wk_locn, $from ) = explode(",", $dummy . ",,");
		header("Location: " . $from . "?message="."End+of+Questions" . "&grn=" . urlencode($wk_orig_issn . "|" . $wk_locn) . "&donetest=Y");
	}
	exit();
?>
