...
if (isset($_COOKIE['LoginUser']))
{
	...
	if (isset($_POST['connote']))
	{
		$wk_order = $_POST['connote'];
	}
	if (isset($_GET['connote']))
	{
		$wk_order = $_GET['connote'];
	}
	$my_object = $wk_order;
	$my_source = 'SSBSSKSSS';
	$my_ref = '';
	...
	$my_message = "";
	//echo("dotransaction_response($tran_type, $tran_tranclass, $my_object, $location, $my_sublocn, $my_ref, $tran_qty, $my_source, $tran_user, $tran_device)");
	...
	if ($my_responsemessage <> "Processed successfully ")
	{
		...
		header("Location: getDStoPL.php?" . $my_message);
		exit();
	}
