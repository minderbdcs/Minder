...
$Query = "select distinct p2.pick_order as PO, p2.volume as vol, p2.net_weight  as Wt, p2.pick_priority as pri ,p2.other2 as cnl,p2.other1 as cnt "; 
/*
$Query .= ", 
...
//echo($Query);
	...
	//$Query .= "group by p2.pick_order, p2.pick_priority, p2.pick_due_date, p2.volume, p2.net_weight  ";
	$Query .= "group by p2.pick_priority, p2.pick_order, p2.pick_due_date, p2.volume, p2.net_weight ,cnt,cnl ";
	$Query .= "having count(*) = 1  ";
