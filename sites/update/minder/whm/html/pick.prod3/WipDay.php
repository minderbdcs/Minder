...
//$wk_query1 = "select person_id,mer_hour(trn_date),count(distinct object) from transactions_archive where trn_type='PKOL' and trn_date > 'TODAY' group by person_id,mer_hour(trn_date) ";  
//$wk_query1 = "select person_id,mer_hour(trn_date),count(distinct object) from transactions_archive where trn_type='PKOL' and trn_code='P' and trn_date >'TODAY' group by person_id,mer_hour(trn_date) ";  
$wk_query1 = "select person_id,mer_hour(trn_date),count(distinct object) from transactions_archive where trn_type='PKOL' and trn_code = 'P' and trn_date >= cast('$work_mm/$work_dd/$work_yy' as timestamp) and trn_date <= cast('$work_mm/$work_dd/$work_yy 23:59:59' as timestamp) group by person_id,mer_hour(trn_date) ";  
{
	echo("<html>\n");
	echo("<head>\n");
