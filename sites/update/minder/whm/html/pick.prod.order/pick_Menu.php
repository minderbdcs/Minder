...
echo('<h2 ALIGN="LEFT">Pick by Order Menu ');
...
echo('</h2>');
	...
	addMenuButton(",VIEWOPEN,", $pick_method, "ViewType.php", "vieworder", "/icons/whm/viewpickswaiting.gif", "View Open");
	if ($allocated_tot <> 0)
	{
	...
	if ($wk_sysuser == 'T')
	{
		...
		addMenuButton(",WIP2,", $pick_method , "WipDay2.php", "WIP2", "/icons/whm/button.php?text=Picks+by+Day&fromimage=Blank_Button_50x100.gif", "Picks 
by Day");
