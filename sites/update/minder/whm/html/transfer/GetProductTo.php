...
?>
  <title>Get Product you are placing TO</title>
...
//echo("<form action=\"PostTo.php\" method=\"post\" name=gettoproduct onsubmit=\"return ProcessEdit();\" >\n");
echo("<form action=\"PostTo.php\" method=\"post\" name=gettoproduct >\n");
 echo("<p>\n");
if (isset($_POST['qtyto'])) 
{
