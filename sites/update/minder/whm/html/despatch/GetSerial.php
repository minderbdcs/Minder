...
/* # save my order */
  var mytype;
	...
	/* alert(myorder); */
  	...
  	document.getperson.pick_label_no.value = mylabel; 
...
echo("<FORM action=\"GetSerial.php\" method=\"post\" name=\"getdetails\">\n");
...
{
	whm2buttons('GetOrder', 'despatch_menu.php', "Y","Back_50x100.gif","Back","nextorder.gif");
}

echo("<FORM action=\"GetSerial2.php\" method=\"post\" name=getperson\n>");
