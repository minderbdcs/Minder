...
/*    display: none; */
    ...
    */
            ...
            function updateUI()
            {
                ...
                document.forms[0].real_product_desc.value = productInfo[selected][0];
                document.forms[0].recvd.value = pickedQtyInfo[selected][0];
                document.forms[0].toreturn.value = returnQty;
            ...
            var pickedQtyInfo = <?php echo json_encode($pickedQty); ?>;
            var returnQty = <?php echo $returnQty; ?>;
            var pageCount   = 0; 
        </script>
    </head>
...
<?php
            ...
            <input type="text"
                   ...
                   autocomplete="off" />
            <input type="hidden"
                   name="real_product_desc" 
                   id="real_product_desc" />
            </div>
            <div id = "actions1">
                <input type="image"
                       name="action_back"
