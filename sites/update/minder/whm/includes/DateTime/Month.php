...
/**
* @package SPLIB
* @version $Id: Month.php,v 1.2 2005/09/05 05:46:44 kevin Exp $
*/
/**
* Define include path and include required files
*/
@define('CALENDAR_PATH','DateTime/');
require_once(CALENDAR_PATH.'DateMath.php');
require_once(CALENDAR_PATH.'Calendar.php');
/**
...
class Month extends Calendar
{
    ...
    */
    function buildWeeks($sDates=array()) {
        require_once(CALENDAR_PATH.'Week.php');
        $this->setDaysOfMonth();
