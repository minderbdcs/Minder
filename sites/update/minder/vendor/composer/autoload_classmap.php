...
return array(
    'ArrayDataSet' => $baseDir . '/tests/acceptance/includes/ArrayDataSet.php',
    'AwaitingChecking_AcceptByAwbConsignmentNo_ScanConnoteNoAndAccept' => $baseDir . '/tests/acceptance/AwaitingChecking/AcceptByAwbConsignmentNo/ScanConnoteNoAndAccept.php',
    'AwaitingChecking_ChangeCarrierAndAcceptOrder_ConfirmDespatchDialogTest' => $baseDir . '/tests/acceptance/AwaitingChecking/ConfirmDespatchDialog/ConfirmDespatchDialogTest.php',
    'AwaitingChecking_ChangeCarrierAndAcceptOrder_RegularAcceptButtonTest' => $baseDir . '/tests/acceptance/AwaitingChecking/ChangeCarrierAndAcceptOrder/RegularAcceptButtonTest.php',
    'AwaitingChecking_EdiOrders_DespatchPolicyTest' => $baseDir . '/tests/acceptance/AwaitingChecking/EdiOrders/DespatchPolicyTest.php',
    'AwaitingChecking_EdiOrders_PartialOrderPolicyTest' => $baseDir . '/tests/acceptance/AwaitingChecking/EdiOrders/PartialOrderPolicyTest.php',
    'AwaitingChecking_PartialDespatch_AllowedTest' => $baseDir . '/tests/acceptance/AwaitingChecking/PartialDespatch/AllowedTest.php',
    'AwaitingChecking_PartialDespatch_NotAllowedTest' => $baseDir . '/tests/acceptance/AwaitingChecking/PartialDespatch/NotAllowedTest.php',
    'ConfirmBarcodeTypeDialogTest' => $baseDir . '/tests/acceptance/AwaitingChecking/ConfirmBarcodeTypeDialog/ConfirmBarcodeTypeDialogTest.php',
    'File_Iterator' => $vendorDir . '/phpunit/php-file-iterator/src/Iterator.php',
    'File_Iterator_Facade' => $vendorDir . '/phpunit/php-file-iterator/src/Facade.php',
    'File_Iterator_Factory' => $vendorDir . '/phpunit/php-file-iterator/src/Factory.php',
    'MinderAcceptanceTestCase' => $baseDir . '/tests/acceptance/includes/MinderAcceptanceTestCase.php',
    'MinderTest' => $baseDir . '/tests/unit/minderTest.php',
    'Minder_LocationGeneratorTest' => $baseDir . '/tests/includes/Minder/LocationGeneratorTest.php',
    'Minder_SequenceGeneratorTest' => $baseDir . '/tests/includes/Minder/SequenceGeneratorTest.php',
    'Minder_SequenceGenerator_RegisterBase_AlphaTest' => $baseDir . '/tests/includes/Minder/SequenceGenerator/RegisterBase/AlphaTest.php',
    'Minder_SequenceGenerator_RegisterBase_Base10Test' => $baseDir . '/tests/includes/Minder/SequenceGenerator/RegisterBase/Base10Test.php',
    'Otc_AddProductDialog_AbstractCase' => $baseDir . '/tests/acceptance/Otc/AddProductDialog/AbstractCase.php',
    'Otc_AddProductDialog_AddProductTest' => $baseDir . '/tests/acceptance/Otc/AddProductDialog/AddProductTest.php',
    'Otc_AddToolDialog_AbstractCase' => $baseDir . '/tests/acceptance/Otc/AddToolDialog/AbstractCase.php',
    'Otc_AddToolDialog_LoanCheckDefaultsTest' => $baseDir . '/tests/acceptance/Otc/AddToolDialog/LoanCheckDefaultsTest.php',
    'Otc_AddToolDialog_NewToolAppearsInIssuesTabTest' => $baseDir . '/tests/acceptance/Otc/AddToolDialog/NewToolAppearsInIssuesTabTest.php',
    'Otc_AddToolDialog_VisibilityTest' => $baseDir . '/tests/acceptance/Otc/AddToolDialog/VisibilityTest.php',
    'Otc_ProductBarcodeTest' => $baseDir . '/tests/acceptance/Otc/ProductBarcodeTest.php',
    ...
    'SerialCheckTest' => $baseDir . '/tests/acceptance/AwaitingChecking/SerialCheck/SerialCheckTest.php',
    'Text_Template' => $vendorDir . '/phpunit/php-text-template/Text/Template.php',
    'Transaction_AllTest' => $baseDir . '/tests/unit/allTest.php',
    'Transaction_AllTests' => $baseDir . '/tests/unit/AllTests.php',
    'Transaction_GRNCCTest' => $baseDir . '/tests/unit/Transaction/GRNCCTest.php',
    'Transaction_GRNCLTest' => $baseDir . '/tests/unit/Transaction/GRNCLTest.php',
    'Transaction_GRNCNTest' => $baseDir . '/tests/unit/Transaction/GRNCNTest.php',
    'Transaction_GRNDBTest' => $baseDir . '/tests/unit/Transaction/GRNDBTest.php',
    'Transaction_GRNDCTest' => $baseDir . '/tests/unit/Transaction/GRNDCTest.php',
    'Transaction_GRNDGTest' => $baseDir . '/tests/unit/Transaction/GRNDGTest.php',
    'Transaction_GRNDLTest' => $baseDir . '/tests/unit/Transaction/GRNDLTest.php',
    'Transaction_GRNVHTest' => $baseDir . '/tests/unit/Transaction/GRNVHTest.php',
    'Transaction_GRNVITest' => $baseDir . '/tests/unit/Transaction/GRNVITest.php',
    'Transaction_GRNVPTest' => $baseDir . '/tests/unit/Transaction/GRNVPTest.php',
    'Transaction_GRNVSTest' => $baseDir . '/tests/unit/Transaction/GRNVSTest.php',
    'Transaction_NIBCATest' => $baseDir . '/tests/unit/Transaction/NIBCATest.php',
    'Transaction_NID3ATest' => $baseDir . '/tests/unit/Transaction/NID3ATest.php',
    'Transaction_NIOBATest' => $baseDir . '/tests/unit/Transaction/NIOBATest.php',
    'Transaction_NITPATest' => $baseDir . '/tests/unit/Transaction/NITPATest.php',
    'Transaction_UGCAATest' => $baseDir . '/tests/unit/Transaction/UGCAATest.php',
    'Transaction_UGCNATest' => $baseDir . '/tests/unit/Transaction/UGCNATest.php',
    'Transaction_UGHCATest' => $baseDir . '/tests/unit/Transaction/UGHCATest.php',
    'Transaction_UGHPATest' => $baseDir . '/tests/unit/Transaction/UGHPATest.php',
    'Transaction_UGONATest' => $baseDir . '/tests/unit/Transaction/UGONATest.php',
    'Transaction_UGRIATest' => $baseDir . '/tests/unit/Transaction/UGRIATest.php',
    'Transaction_UGSNATest' => $baseDir . '/tests/unit/Transaction/UGSNATest.php',
    'Transaction_UICOATest' => $baseDir . '/tests/unit/Transaction/UICOATest.php',
    'Transaction_UIDIATest' => $baseDir . '/tests/unit/Transaction/UIDIATest.php',
    'Transaction_UIKTATest' => $baseDir . '/tests/unit/Transaction/UIKTATest.php',
    'Transaction_UIO1ATest' => $baseDir . '/tests/unit/Transaction/UIO1ATest.php',
    'Transaction_UIO2ATest' => $baseDir . '/tests/unit/Transaction/UIO2ATest.php',
    'Transaction_UIPCATest' => $baseDir . '/tests/unit/Transaction/UIPCATest.php',
    'Transaction_UISCATest' => $baseDir . '/tests/unit/Transaction/UISCATest.php',
    'Transaction_UISNATest' => $baseDir . '/tests/unit/Transaction/UISNATest.php',
);
