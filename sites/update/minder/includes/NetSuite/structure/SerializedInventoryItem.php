...
/**
 * SerializedInventoryItem map NetSuite datatype
 *
 * @category  Minder
 * @package   Minder
 * @author    Sergey Boroday <sergey.boroday@binary-studio.com>
...
class NetSuite_SerializedInventoryItem {
    public $createdDate;
