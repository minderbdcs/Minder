...
/**
 * CrmCustomField map NetSuite datatype
 *
 * @category  Minder
 * @package   Minder
 * @author    Sergey Boroday <sergey.boroday@binary-studio.com>
...
class NetSuite_CrmCustomField {
    ...
    public $filterList; //NetSuite_CrmCustomFieldFilterList
    public $internalId;

    public function __construct(  $label, $fieldType, NetSuite_RecordRef $selectRecordType, $storeValue, $showInList, $isParent, NetSuite_RecordRef $insertBefore, NetSuite_RecordRef $subtab, $displayType, $displayWidth, $displayHeight, $help, NetSuite_RecordRef $parentSubtab, $linkText, $isMandatory, $maxLength, $minValue, $maxValue, $defaultChecked, $defaultValue, $isFormula, NetSuite_RecordRef $defaultSelection, $dynamicDefault, NetSuite_RecordRef $sourceList, NetSuite_RecordRef $sourceFrom, NetSuite_RecordRef $sourceFilterBy, $appliesToTask, $appliesToPhoneCall, $appliesToEvent, $appliesToCase, $appliesToCampaign, $appliesPerKeyword, $appliesToSolution, $availableExternally, NetSuite_CrmCustomFieldFilterList $filterList, $internalId) {
        $this->label = $label;
