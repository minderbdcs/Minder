...
/**
 * VendorSearch map NetSuite datatype
 *
 * @category  Minder
 * @package   Minder
 * @author    Sergey Boroday <sergey.boroday@binary-studio.com>
...
class NetSuite_VendorSearch {
    public $basic; //NetSuite_VendorSearchBasic
