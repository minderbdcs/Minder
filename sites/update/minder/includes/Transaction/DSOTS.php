...
class Transaction_DSOTS Extends Transaction_DSOT
{
    ...
    public static $orderNoTriggerLen       = 10;    
    public static $orderNoOverflow       = 'ORDER2BIG';    
...
//        return $this->objectId;
	...
	$wkAddOrder =  (strlen($this->orderNo) > self::$orderNoTriggerLen) ?  $this->orderNo : '' ;
    ...
    public function getLocation()
    {
        $this->_checkMaxLenLimit('orderNo', self::$orderNoMaxLen);
       	//return $this->orderNo;
	if (strlen($this->orderNo) > self::$orderNoTriggerLen) {
		return self::$orderNoOverflow;
	} else {
        	return $this->orderNo;
        }
    }
