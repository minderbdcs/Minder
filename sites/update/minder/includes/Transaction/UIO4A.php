...
class Transaction_UIO4A Extends Transaction
{
    /**
    ...
    public $objectId;
    /**
     * The ISSN.OTHER4 Field to be updated with this value
     *
     * @var string
     */
    public $other4Value;
    ...
    {
        if (strlen($this->other4Value) > 40) {
            return substr($this->other4Value, 0, 40);
        } else {
