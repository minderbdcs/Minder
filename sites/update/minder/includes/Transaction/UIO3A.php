 ...
 * @category  Minder
 * @package   Minder
 * @author    Suhinin Dmitriy <suhinin.dmitriy@bgmail.com>
...
class Transaction_UIO3A Extends Transaction
{
    /**
    ...
    public $objectId;
    /**
     * The ISSN.OTHER3 Field to be updated with this value
     *
     * @var string
     */
    public $other3Value;
    ...
    {
        if (strlen($this->other3Value) > 40) {
            return substr($this->other3Value, 0, 40);
        } else {
