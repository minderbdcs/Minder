...
class SysScreenTable extends AbstractTable {
    protected $_name = 'SYS_SCREEN_TABLE';
    protected $_primary = 'RECORD_ID';

    public function getScreenTables($screens, \Minder2_Model_SysUser $user, \Minder2_Model_SysEquip $device, \Minder2_Model_Company $companyLimit) {
        if (empty($screens)) {
            return array();
        }
