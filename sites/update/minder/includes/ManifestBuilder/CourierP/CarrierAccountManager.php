...
class ManifestBuilder_CourierP_CarrierAccountManager implements ManifestBuilder_DbAdapterAwareInterface {
    /**
    ...
    public function getAccounts(array $carrierIds, $manifestId) {
        ...
        foreach ($this->_getCarrierAccountsUsed($carrierIds, $manifestId) as $dataRow) {
            ...
            $result[] = new ManifestBuilder_CourierP_CarrierAccount($dataRow['ACCOUNT'], $carrier, $carrierServices);
        }
