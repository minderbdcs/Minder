...
class ManifestBuilder_AustPost_Provider_Article implements ManifestBuilder_DbAdapterAwareInterface {
    ...
    public function getConnoteArticles(ManifestBuilder_AustPost_Model_Consignment $connote) {
        ...
        foreach ($select->query()->fetchAll() as $resultRow) {
            $tmpArticle = new ManifestBuilder_AustPost_Model_Article($resultRow);
    ...
    protected function _getArticleNumber(ManifestBuilder_AustPost_Model_Article $article) {
