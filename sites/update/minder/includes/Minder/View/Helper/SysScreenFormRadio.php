...
class Minder_View_Helper_SysScreenFormRadio extends Zend_View_Helper_FormRadio {
    public function sysScreenFormRadio($attribs = array(), $fieldDesc, $actions) {
Zend_Registry::get('logger')->debug(array('file' => __FILE__, 'line' => __LINE__, $fieldDesc));
...
//                    break;
        ...
        $xhtml  = $this->formRadio($name, $value, $tmpAttribs, $fieldDesc['OPTIONS'], '&nbsp;&nbsp;');
//        $xhtml .= '
