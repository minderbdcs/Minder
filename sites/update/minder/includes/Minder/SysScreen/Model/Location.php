...
class Minder_SysScreen_Model_Location extends Minder_SysScreen_Model {
    ...
    public function printLabel($printer) {
        ...
        $locationLabelPrinter = new Minder_LabelPrinter_Location();
        return $locationLabelPrinter->doPrint(
