...
//        } else {
//            $shortcuts['Awaiting Checking']     =   $this->view->url(array('action' => 'index', 'controller' => 'despatch-awaiting-checking'), null, true);
//        }
//
...
//        $shortcuts['Consignment Exit']            =   $this->view->url(array('action' => 'awaiting-exit', 'controller' => 'despatch'), null, true);
//        $shortcuts['Austpost Manifest']           =   $this->view->url(array('action' => 'index', 'controller' => 'austpost-manifest', 'module' => 'despatches'), null, true);
//        $shortcuts['View Despatched Orders']      =   $this->view->url(array('action' => 'despatched-orders', 'controller' => 'despatch'), null, true);
