			...
			if(true) {
				...
				if ($addResult) {
					if ($shipping_container!='' && $vessel_name!='') {
						 ...
						 * REFERENCE = 'IP|PO24164||vessel|'  PDF saysIP+PURCHASE_ORDER||Y|U|0|N||||
