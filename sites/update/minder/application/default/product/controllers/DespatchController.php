...
class DespatchController extends Minder_Controller_Action
{
    ...
    public function connoteAction() {
        ...
        */
        ...
        if(count($totalUnicOrders) > 1){
            $this->addError('You have more than 1 Order selected, please <a href="./" style="color:#003399; text-decoration:underline;">go back</a> and use "CLEAR SELECTION" button.');    
        }
    ...
    public function linesAction()
    {
        ...
        $conditions     =   $this->_getConditions('inidex');
                    ...
                    if(count($selectedConnote) > 0) { 
                        foreach($allList as $line){
                            if(in_array($line['DESPATCH_ID'], $selectedConnote)) {
                                ...
                                $this->addError($printResult->warnings);
