...
class TransferOrderController extends Minder_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->view->pageTitle     = 'Transfer Orders';
...
*/
                ...
                case 'add':
                    ...
                    switch($mode){
                        case 1:
                            ...
                            $this->_redirector = $this->_helper->getHelper('Redirector');
                            $this->_redirector->setCode(303)->goto('description', 'object');
        ...
        $fieldsData = $this->minder->getUserHeaders('SCN_DESPOR', array());
