    ...
    protected function _setupHeaders()
    {
        if (!parent::_setupHeaders()) {
           $this->session->headers[$this->_controller][$this->_action][$this->view->tableId] =
                $this->view->headers = $this->minder->getSelectField( "GRN");
/*
                $this->view->headers = array(
                    'GRN'                => 'GRN',
                    'ORDER_NO'           => 'Order #',
                    ...
                    'GRN_DATE'           => 'GRN Date',
                    'AWB_CONSIGNMENT_NO' => 'AWB Consignment #',
                    'OWNER_ID'           => 'Owner ID',
                    'PALLETS_YN'         => 'Pallet Owner',
                    'PACK_CRATE_OWNER'   => 'Hire Crate Owner',
                    'LAST_PALLET_NO'     => 'Last Pallet #',
                    'USER_ID'            => 'User ID'
                );
*/
        } else {
