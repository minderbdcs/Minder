...
class Despatches_PersonController extends Minder_Controller_Action_Despatches
{
    ...
    protected static $personSelectionModule     = 'despatches';
    ...
    protected static $personAddressSelectionModule     = 'despatches';
    ...
    public function init() {
        ...
        $this->view->reportModule     = 'despatches';
        $this->view->reportController = 'person';
        $this->view->reportAction     = 'report';
        
        $this->view->addresLabelModule     = 'despatches';
    ...
    public function getAddressesAction() {
        ...
        try {
            ...
            usort($this->view->personAddressButtons, array($this, '_sortButtons'));
    ...
    public function saveChangesAction() {
        ...
        $response->location = $this->view->url(array('action' => 'index', 'controller' => 'person', 'module' => 'despatches'), null, true);
