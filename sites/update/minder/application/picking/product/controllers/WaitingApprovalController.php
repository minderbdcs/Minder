...
class Picking_WaitingApprovalController extends Minder_Controller_Action_Picking 
{
    public function init() {
        parent::init();
        
        $this->view->orderSysScreenName       = 'WAITAPPROVAL';
        $this->view->orderSelectionNamespace  = 'order_wait_approval_selection_namespace';
        ...
        $this->view->linesSysScreenName       = 'WAITAPPROVALLINES';
        $this->view->linesSelectionNamespace  = 'lines_wait_approval_selection_namespace';
        ...
        $this->view->pageTitle = 'Awaiting Approval';
    }
    ...
    public function indexAction() {
        ...
        try {
            $orderModel = new Minder_SysScreen_Model_WaitingApproval();
