...
if os.name == 'nt':
	logfile = "d:/tmp/getgltd.log"
else:
	logfile = "/tmp/getgltd.log"
havelog = 1;
...
#tran_data += tran_delim + "<EANNumber>9320075375050" + tran_delim
tran_data += tran_delim + "<GetAllLiterature>true" + tran_delim
#tran_data += tran_delim + "<EANExtension>" + tran_delim
