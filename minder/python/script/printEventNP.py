...
<long>
Reads PRINT_REQUEST records in the database of NP status
...
"""
	...
	if data_fields is None:
		...
		while not data_fields is None:
			...
			prnRealFile = prnFolder + message_id + ".create"
...
if os.name == 'nt':
	logfile = "d:/tmp/printEventFileNP."
else:
	logfile = "/tmp/printEventFileNP."
havelog = 1;
...
for i in range( len(sys.argv)):
	...
	if "passwd"  == myparms[0]:
		mypasswd = myparms[1]
	if "tmp"  == myparms[0]:
		logfile  = myparms[1] + "/printEventFileNP."
