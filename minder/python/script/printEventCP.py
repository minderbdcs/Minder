...
<long>
Reads PRINT_REQUEST records in the database of CP status
...
###############################################################################
#1st read a CP status print request
#for this record
#
...
"""
	...
	if data_fields is None:
		...
		while not data_fields is None:
			...
			prnRealFile = prnFolder + message_id + ".send"
...
if os.name == 'nt':
	logfile = "d:/tmp/printEventFileCP."
else:
	logfile = "/tmp/printEventFileCP."
havelog = 1;
...
for i in range( len(sys.argv)):
	...
	if "passwd"  == myparms[0]:
		mypasswd = myparms[1]
	if "tmp"  == myparms[0]:
		logfile  = myparms[1] + "/printEventFileCP."
