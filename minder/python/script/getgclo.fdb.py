...
<br>
this uses the fdb database library
<br>
</long>
"""
import sys
...
#tran_data += tran_delim + "<ContactInstanceID>2101283" + tran_delim
#tran_data += tran_delim + "<ContactInstanceID>2101098" + tran_delim
tran_data += tran_delim + "<ContactInstanceID>2101946" + tran_delim
