...
<style>
    body {
        ...
        *background-image: url("/tollgate/background.png");
...
<div class="table">
    <div class="table-cell">
        <div id="content">
            <img src="/tollgate/icons/MDR_30x29.jpg" alt="company logo" />
            <h1>TollGate Minder <br />by Barcoding & Data Collection Systems P/L</h1>
            <div id="menu">
                <div class="menu-button-first"><a href="#">
                    <span class="hot-key">M</span>
                    <span>Manual</span>
                </a></div>
                <div class="menu-button-second"><a href="config.php">
                    <span class="hot-key large">*</span>
                    <span>Utils</span>
                </a></div>
                <div class="menu-button-third"><a href="alterdate.php">
                    <span class="hot-key">D</span>
                    <span>Date</span>
                </a></div>
                <div class="menu-button-fourth"><a href="totals.php">
